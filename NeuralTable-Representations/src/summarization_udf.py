...
def summarize(descriptions: list[str]) -> str:
    ...
    system_prompt = """
    You are a helpful assistant skilled in summarizing subjective descriptions provided by multiple individuals. 
    ...
    content = f"""
    Please summarize the following personal descriptions:
...
with open('../llmResponse.txt', "a", encoding="utf-8") as file:
    for file in files:
        ...
        #summarization = summarize(descriptions)
